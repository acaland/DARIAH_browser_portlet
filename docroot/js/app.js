...
isc.DataSource.create({
	...
	fields: [
	         ...
	         { name: 'untertitel', autoFitWidth: true, detail: true  },
	         { name: 'bandtitel', detail: true },
	         { name: 'baende', type: 'integer', detail: true },
	         { name: 'band', detail: true },
	         { name: 'reihentitel',  autoFitWidth: true, detail: true  },
	         { name: 'reihennummer', detail: true },
	         { name: 'auflage', detail: true },
	         ...
	         { name: 'bearbeiter', detail: true },
	         { name: 'herausgeber', detail: true },
	         { name: 'herausgeberreihe', detail: true },
	         { name: 'kurzzitat' },
	         { name: 'kurzzitatSort', detail: true },
	         { name: 'langzitat', autoFitWidth: true },
	         { name: 'verweiszitat', detail: true },
	 		{ name: 'erscheinungszeitbis', type: 'integer' },
...
//console.log("ci siamo?", prova);

function login(_callback) {
	var data = JSON.stringify({ username: "dariahadmin", password: ""});
...
window.onresize = function(evt) {
	...
	pageLayout.setWidth(document.getElementById('app-container').offsetWidth);
};
